...
class Program
{
    ...
    {
        SayaTubeUser user1 = new SayaTubeUser("Alvan");
        SayaTubeVideo vid1 = new SayaTubeVideo("Review Film Godzilla Minus One oleh Alvan Marvianto");
        user1.AddVideo(vid1);
        vid1.IncreasePlayCount(12375);
        SayaTubeVideo vid2 = new SayaTubeVideo("Review Film Kung Fu Panda oleh Alvan Marvianto");
        user1.AddVideo(vid2);
        vid2.IncreasePlayCount(50435);
        SayaTubeVideo vid3 = new SayaTubeVideo("Review Film Pengabdi Setan oleh Alvan Marvianto");
        user1.AddVideo(vid3);
        vid3.IncreasePlayCount(92804);
        SayaTubeVideo vid4 = new SayaTubeVideo("Review Film Shawshank Redemption oleh Alvan Marvianto");
        user1.AddVideo(vid4);
        vid4.IncreasePlayCount(5495);
        SayaTubeVideo vid5 = new SayaTubeVideo("Review Film Truman Show oleh Alvan Marvianto");
        user1.AddVideo(vid5);
        vid5.IncreasePlayCount(903285);
        SayaTubeVideo vid6 = new SayaTubeVideo("Review Film Kong oleh Alvan Marvianto");
        user1.AddVideo(vid6);
        vid6.IncreasePlayCount(94343);
        SayaTubeVideo vid7 = new SayaTubeVideo("Review Film Jurassic Park oleh Alvan Marvianto");
        user1.AddVideo(vid7);
        vid7.IncreasePlayCount(94382);
        SayaTubeVideo vid8 = new SayaTubeVideo("Review Film Back to the Future oleh Alvan Marvianto");
        user1.AddVideo(vid8);
        vid8.IncreasePlayCount(423902);
        SayaTubeVideo vid9 = new SayaTubeVideo("Review Film Zootopia oleh Alvan Marvianto");
        user1.AddVideo(vid9);
        vid9.IncreasePlayCount(032532);
        SayaTubeVideo vid10 = new SayaTubeVideo("Review Film Aquaman oleh Alvan Marvianto");
        ...
        try
        {
            SayaTubeVideo vid13 = new SayaTubeVideo("Tutorial Design By Contract – Alvan Marvianto");
        ...
        SayaTubeVideo vid14 = new SayaTubeVideo("Tutorial Design By Contract – Alvan Marvianto");
